...
const AlterarRegra = () => {
  ...
  const [formProdutosQualidade, setformProdutosQualidade] = useState({})
  ...
  useEffect(() => {
    ...
    window.axios.get(`qualidadeProduto/${idRegra}?m=q`).then(({ data }) => {
      setformProdutosQualidade({ ...formProdutosQualidade, ...data });
    });
  }, []);
                ...
                <tr key={p.id}>
                  ...
                  <th style={{ width: "10%" }}>
                    <div className="d-flex align-items-center justify-content-center">
                      <Form.Check
                        name={p.id}
                        checked={Array.isArray(formProdutosQualidade) && formProdutosQualidade.some((pq) => pq.produtoId === p.id)}
                        onChange={atualizar}
                      />
                    </div>
                  </th>
                  <th style={{ width: "10%" }}>
                    <div className="d-flex align-items-center justify-content-center">
                      ...
                      >
                        <FontAwesomeIcon
                          icon="fa-solid fa-triangle-exclamation text-dark"
                        />
                      </button>
                    </div>
                  </th>
